...
/// <summary>
/// Depoya ürün giriş hareketlerinin Business katmanı üzerinden kaydedildiği formdur.
/// </summary>
public class FrmStokGiris : Form
{
    ...
    {
        ModernUi.ConfigureForm(this, "Stok Giriş", 1120, 720);
    ...
    private void BuildHeader()
    {
        ...
        headerCard.Controls.Add(ModernUi.Label(
            "İşletmeye gelen ürünleri sisteme ekleyerek stok miktarını artırabilirsiniz.",
            28,
            52,
            760,
            22,
    ...
    private void BuildFormCard()
    {
        ...
        formCard.Controls.Add(ModernUi.Label(
            "Ürün, miktar ve açıklama bilgilerini girerek stok hareketi oluşturun.",
            24,
            48,
            420,
            20,
    ...
    private void BuildInfoCard()
    {
        ...
        infoCard.Controls.Add(ModernUi.Label(
            "Seçilen ürünün stok miktarı, girilen miktar kadar artırılır. Eksik veya hatalı bilgi varsa sistem popup uyarısı verir.",
            24,
            50,
            450,
            40,
    ...
    private void BuildTableCard()
    {
        ...
        tableCard.Controls.Add(ModernUi.Label(
            "Depoya eklenen ürünlerin son stok giriş hareketleri burada listelenir.",
            24,
            43,
            520,
            20,
    ...
    private void BtnGiris_Click(object? sender, EventArgs e)
    {
        try
        {
            ...
            {
                WinFormsUiHelper.ShowWarning("Lütfen stok girişi yapılacak ürünü seçiniz.");
                return;
            }

            if (_numMiktar.Value <= 0)
            {
                WinFormsUiHelper.ShowWarning("Giriş miktarı 0'dan büyük olmalıdır.");
                return;
            }
            ...
            WinFormsUiHelper.ShowSuccess("Stok girişi başarıyla yapıldı.");
    ...
    private void BtnListele_Click(object? sender, EventArgs e)
    {
        UrunleriYukle();
        Listele();
        WinFormsUiHelper.ShowInfo("Stok giriş kayıtları yenilendi.");
    }
    ...
    private void GridKolonlariniDuzenle()
    {
        ...
        SetHeader("GirisTarihi", "Giriş Tarihi");
